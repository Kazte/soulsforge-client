      ...
      <div className="flex flex-row items-center justify-center gap-2 text-center px-2">
        <Switch>
          <Case condition={editing}>
            <CharacterLabel editing={editing} value={r || 0} color={`${textColor}`} onChange={r => handleChange((r as number), g, b)} />
            <CharacterLabel editing={editing} value={g || 0} color={`${textColor}`} onChange={g => handleChange(r, (g as number), b)} />
            <CharacterLabel editing={editing} value={b || 0} color={`${textColor}`} onChange={b => handleChange(r, g, (b as number))} />
          </Case>
          <Default>
